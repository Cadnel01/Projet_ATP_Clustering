...
## Les clusters - Interprétation
  ...
  Le premier cluster se démarque des autres sur plusieurs points. Une analyse en composante principale montre certaine corrélation entre les caractéristiques des joueurs, d'une part le nombre d'ace et la taille des joueurs et d'une autre part le nombre de break points sauvés et rencontrés, ainsi que le nombre de point gagné lors du premier échange (variable stWon).Le groupe se caractérise par 3/4 des joueurs avec une taille en dessous de la moyenne et un nombre d'ace réalisé inférieur à la moyenne pour plus des 3/4 des joueurs (Annexe 1). De plus, leur nombre de points gagnés lors du premier échange est faible. ce qui peut témoigner d'une faible attaque des joueurs. De même, ils ont un plus faible taux de break points sauvés et rencontrés que pour les autres clusters. En effet, ils sauvent en moyenne 52% des break points. Enfin, ce cluster est composé de joueurs jouant des matchs beaucoup plus courts en moyenne que pour les joueurs des autres clusters (Annexe 2). Cela pourrait s'expliquer par le fait de ne pas jouer de grand chelems. 

Ainsi ce groupe serait composé des joueurs plutôt de petite taille, n'ayant pas un service puissant et/ou une attaque puissante. De plus, ils joueraient des matchs plus courts en moyenne, ce qui pourrait signifier qu'ils ne jouent pas ou peu de grands chelems. Tout ceci pourrait avoir un lien avec le fait que ce cluster est caractérisé par des joueurs plutôt jeunes. En effet, 50% des joueurs ont moins de 26 ans et 75% moins de 28 ans, alors que l'age moyen de l'ensemble des joueurs ATP de 2012 est de 27 ans. Les joueurs de ce cluster sont donc en général plus jeunes que la moyenne.
